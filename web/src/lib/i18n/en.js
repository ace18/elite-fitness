...
export const en = {
  ...
  train: {
    ...
    syncPendingOne: 'One workout waiting to sync',
    syncPendingMany: '{n} workouts waiting to sync',
    syncNow: 'Sync now',
    syncing: 'Syncing…',
    thisWeek: 'This week',
    yourPlan: 'Your plan',
  ...
  session: {
    ...
    rpeHint: 'tap how hard it felt',
    rpeMaximal: 'maximal',
    rpeHard: 'hard — 1-2 left',
    rpeChallenging: 'challenging',
    rpeEasy: 'easy',
    newPr: '🏆 New PR — {lift}!',
    rest: 'REST',
    upNext: 'Up next · ',
