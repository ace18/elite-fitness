...
{#if stage === 'sent'}
  <Screen bg="#fff">
    <div class="scr-in" style="padding:40px 26px; min-height:760px; display:flex; flex-direction:column;">
      ...
      <!-- simulated "open email" so the flow is tappable end-to-end -->
      <div class="card--flat" style="margin-top:24px; padding:16px; display:flex; gap:12px; align-items:center;">
        ...
        <div style="flex:1; min-width:0;">
          ...
          <div class="t-sub" style="font-size:12.5px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">Your secure link is ready ›</div>
        </div>
      </div>
      <div style="margin-top:auto; display:flex; flex-direction:column; gap:10px; padding-top:24px;">
        ...
        <button onclick={() => (stage = 'form')} class="btn btn--ghost btn--block">Use a different email</button>
      </div>
    </div>
  </Screen>
{:else}
